  ...
  return (
    <div className="container animate-fade-in" style={{ marginTop: '40px' }}>
      ...
      <div className="card" style={{ padding: '40px', lineHeight: '1.6' }}>
        <h3 style={{ borderBottom: '2px solid var(--primary)', paddingBottom: '10px', display: 'inline-block' }}>Nuestra Misión</h3>
        ...
        <h3 style={{ borderBottom: '2px solid var(--primary)', paddingBottom: '10px', display: 'inline-block' }}>Nuestra Visión</h3>
